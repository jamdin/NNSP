function [pred,res]=datosPartidosAG2(liga,par)
...
%liga='Espana';
    ...
    switch liga
        case 'Espana'
            ...
            load RedNeuronalSPLocal2
            c1={Theta1;Theta2;ms};
            load RedNeuronalSPVisitante2
            c2={Theta1;Theta2;ms};
            load RedNeuronalSPDirecto2
            c3={Theta1;Theta2;ms};
            load RedNeuronalSPUnion2
            c4={Theta1;Theta2;ms};
...
for i=1:size(xsub,1)
    ...
    [p,h]=predecirPartido3(c1,c2,c3,c4,datos,teams,eqlocal,eqvis,jornada);
    res=[res;p];
    ap=xsub(i,3:5);
